  ...
  <div id="list" className="pure-u-1">
    ...
    <div className="email-item email-item-unread pure-g">
      ...
      <div className="pure-u-3-4">
        ...
        <p className="email-desc">
          Hey, I had some feedback for pull request #51. We should center the
          menu so it looks better on mobile.
        </p>
      </div>
    </div>
    ...
    <div className="email-item pure-g">
      ...
      <div className="pure-u-3-4">
        ...
        <p className="email-desc">
          Mauris tempor mi vitae sem aliquet pharetra. Fusce in dui purus, nec
          malesuada mauris.
        </p>
      </div>
    </div>
